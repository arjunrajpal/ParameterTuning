...
def random_forest(a, b, c, d, candidate):
    ...
    print "Max feature : " + str(candidate["tunings"][0])
    print "Max leaf nodes : " + str(candidate["tunings"][1])
    print "Min sample split : " + str(candidate["tunings"][2])
    print "Min samples leaf : " + str(candidate["tunings"][3])
    print "Max no of estimators : " + str(candidate["tunings"][4])
...
def initialisePopulation(np,noOfParameters):
    ...
    for i in range(0,np):
        ...
        max_feature = int(nump.random.uniform(algoParameters[0]['low'], algoParameters[0]['high']))
        print "Max Feature selected for index " + str(i) + " : " + str(max_feature)
        tunings.append(max_feature)

        max_leaf_nodes = int(nump.random.uniform(algoParameters[1]['low'], algoParameters[1]['high']))
        ...
        n_estimators = int(nump.random.uniform(algoParameters[4]['low'], algoParameters[4]['high']))
...
def DE(np, f, cr, life, noOfParameters, datasets):
    ...
    # if population["tunings"] != global_best["tunings"]:
...
algoParameters = [{'low': 1, 'high': 17}, {'low': 2, 'high': 50}, {'low': 2, 'high': 20}, {'low': 1, 'high': 20}, {'low': 50, 'high': 150}]
