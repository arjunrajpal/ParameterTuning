...
def random_forest(a, b, c, d, candidate):
    print color.BOLD + color.RED + "Candidate in Random Forest : " + str(candidate) + color.END
...
def extrapolate(old, pop, cr, f, noOfParameters, index):
    ...
    print color.BOLD + color.BLUE + "\nThe other 3 selected rows for index " + str(index) + " : " + color.END
    print a
    print b
    print c
    ...
    print color.BOLD + color.GREEN + "Original Score : " + str(score_original) + color.END

    score_mutant = score(dict_mutant, datasets)
    print color.BOLD + color.GREEN + "Mutant Score : " + str(score_mutant) + color.END
...
def DE(np, f, cr, life, noOfParameters, datasets):
    ...
    while life > 0:
        ...
        print color.BOLD + color.PURPLE + "\nOld Population :" + color.END
        print oldPopulation

        print color.BOLD + color.YELLOW + "\nGlobal Population :" + color.END
...
print (score_test(parameters, datasets) * 100)
